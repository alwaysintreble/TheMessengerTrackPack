LOCATIONS = {
    ...
    { "@The Shop/Karuta Plates" },
    { "@The Shop/Serendipitous Bodies" },
    { "@The Shop/Path of Resilience" },
    { "@The Shop/Kusari Jacket" },
    { "@The Shop/Energy Shuriken" },
    { "@The Shop/Serendipitous Minds" },
    { "@The Shop/Prepared Mind" },
    { "@The Shop/Meditation" },
    { "@The Shop/Rejuvenative Spirit" },
    { "@The Shop/Centered Mind" },
    { "@The Shop/Strike of the Ninja" },
    { "@The Shop/Second Wind" },
    { "@The Shop/Currents Master" },
    { "@The Shop/Aerobatics Warrior" },
    { "@The Shop/Demon's Bane" },
    { "@The Shop/Devil's Due" },
    { "@The Shop/Time Sense" },
    { "@The Shop/Power Sense" },
    { "@The Shop/Focused Power Sense" },
    { "@Figurines/Green Kappa Figurine" },
    { "@Figurines/Blue Kappa Figurine" },
    { "@Figurines/Ountarde Figurine" },
    { "@Figurines/Red Kappa Figurine" },
    { "@Figurines/Demon King Figurine" },
    { "@Figurines/Quillshroom Figurine" },
    { "@Figurines/Jumping Quillshroom Figurine" },
    { "@Figurines/Scurubu Figurine" },
    { "@Figurines/Jumping Scurubu Figurine" },
    { "@Figurines/Wallaxer Figurine" },
    { "@Figurines/Barmath'azel Figurine" },
    { "@Figurines/Queen of Quills Figurine" },
    { "@Figurines/Demon Hive Figurine" },
    { "@The Shop/Money Wrench" },
}
